...
public class Register {
    ...
    public Boolean registerUser(String Username, String Password, Boolean makeUsernameDynamic)
        ...
        WebElement register_now_button =
                this.driver.findElement(By.xpath("//button[text()='Register Now']"));;
        ...
        // we are waiting for either of the condtion (username alreay exists or redirecting to login
        // page) to be satisfied
