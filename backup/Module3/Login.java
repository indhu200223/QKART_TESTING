...
public class Login {
    ...
    public Boolean PerformLogin(String Username, String Password) throws InterruptedException {
        ...
        FluentWait<WebDriver> fwait = new FluentWait<>(driver); // creating object of fluent wait
        fwait.withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofMillis(250));

        fwait.until(ExpectedConditions.invisibilityOfElementLocated(By.className("button"))); //waiting for the element to be disappeared
