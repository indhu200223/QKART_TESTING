...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> checkoutbuttons = driver.findElements(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']/div[1]/p"));
    ...
    public Boolean verifyInsufficientBalanceMessage() {
       ...
       WebElement insufficientbalanceMessage = driver.findElement(By.xpath("//div[@class='SnackbarItem-message']"));
