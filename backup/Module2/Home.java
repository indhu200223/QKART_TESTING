        ...
        try {
            ...
            for (WebElement parentElement : parentElements) {
                ...
                while (true) {
                    ...
                    WebElement currentQuantityElement =
                    ...
                    // converting string into integer using parseint
                      ...
                      Thread.sleep(3000); //during adding and decreasing thr product, it is taking some time to do 
                    }
            ...
            if (quantity == 0) ///if the actual quantity is 0 (given quantity), then only it will come to  catch block
                return true;
